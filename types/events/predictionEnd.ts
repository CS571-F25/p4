export const predictionEnd = {
        ...
        items: {
            ...
            topPredictors: {
                ...
                items: {
                    ...
                    // points won is null if refunded or lost
                    channelPointsWon: { format: 'number', twitch: ['channel_points_won'] },
    ...
    text: {
        twitch: (data: { outcomes: { title: string }[] }) => {
            return `the prediction has ended! winner: ${data.outcomes[0].title}`;
        },
    },
};
